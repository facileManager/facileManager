...
HTML;
	...
	function printForm($data = '', $action = 'add', $type = 'host', $addl_vars = null) {
		...
		/** Get child elements */
		$lease_time = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'default-lease-time')));
		$max_lease_time = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'max-lease-time')));
		$boot_filename = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'filename')));
		$boot_file_server = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'next-server')));
		$server_name = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'server-name')));
		$bootp_lease_length = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'dynamic-bootp-lease-length')));
		$bootp_lease_cutoff = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'dynamic-bootp-lease-cutoff')));
		$ddns = buildSelect('ddns-updates', 'ddns-updates', $on_off, $this->getConfig($config_id, 'ddns-updates'));
		$ddns_domain_name = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'ddns-domainname')));
		$ddns_rev_domain_name = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'ddns-rev-domainname')));
		$ddns_hostname = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'ddns-hostname')));
		...
		$host_name = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'host-name')));
		$routers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'routers')));
		$subnet_mask = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'subnet-mask')));
		$domain_name_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'domain-name-servers')));
		$broadcast_address = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'broadcast-address')));
		$domain_name = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'domain-name')));
		$domain_search = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'domain-search')));
		$time_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'time-servers')));
		$log_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'log-servers')));
		$swap_server = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'swap-server')));
		$root_path = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'root-path')));
		$nis_domain = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'nis-domain')));
		$nis_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'nis-servers')));
		$font_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'font-servers')));
		$x_display_manager = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'x-display-manager')));
		$ntp_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'ntp-servers')));
		$netbios_name_servers = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'netbios-name-servers')));
		$netbios_scope = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'netbios-scope')));
		$netbios_node_type = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'netbios-node-type')));
		$time_offset = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'time-offset')));
		$dhcp_server_identifier = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'dhcp-server-identifier')));
		$slp_directory_agent_entry = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'slp-directory-agent')));
		...
		$slp_service_scope_entry = str_replace(array('\"', '"', "'", '&quot;'), '', html_entity_decode($this->getConfig($config_id, 'slp-service-scope')));
