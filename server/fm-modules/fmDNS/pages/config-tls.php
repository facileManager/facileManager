...
$fm_module_tls = new facileManager\fmDNS\Tls();

$server_serial_no = (isset($_REQUEST['server_serial_no'])) ? sanitize($_REQUEST['server_serial_no']) : 0;
$display_option_type_sql = 'tls';
...
echo printPageHeader(array('message' => (string) $response, 'comment' => getMinimumFeatureVersion($display_option_type_sql)), null, currentUserCan('manage_servers', $_SESSION['module']), null, null, 'noscroll', $addl_title_blocks);
