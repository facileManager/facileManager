...
if (isset($fm_name)) {
	$__FM_CONFIG['module']['icons']['sub_delete']	= sprintf('<a class="tooltip-bottom mini-icon" data-tooltip="%s"><i id="__ID__" class="fa fa-trash delete subelement_remove" aria-hidden="true"></i></a>', _('Delete'));
}
