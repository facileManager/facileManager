...
$fm_module_services = new \facileManager\fmFirewall\Services();
...
$result = basicGetList('fm_' . $__FM_CONFIG[$_SESSION['module']]['prefix'] . 'services', array($sort_field, 'service_name'), 'service_', $search_query, null, false, $sort_direction);
