...
';
	...
	$(document).keyup(function(e) {
		var $focused = $(":focus");
		if ($focused.closest(".select2-container").length || $focused.is("select, .select2-search__field")) {
			return;
		}
		if (e.keyCode == KEYCODE_ESC && $("#manage_item_contents").is(":visible")) { $("#cancel_button").click(); }
