	...
	$module_menu = <<<HTML
		...
		<ul>
			<li class="has-sub"><a href="#"><i class="fa fa-bars fa-lg menu-icon" aria-hidden="true"></i></a>
				<ul class="sub-right">
					<li><a href="https://docs.facileManager.com" target="_blank"><span class="menu-icon"><i class="fa fa-life-ring" aria-hidden="true"></i></span><span>$help</a></span> <span class="menu-icon mini-icon grey"><i class="fa fa-external-link" aria-hidden="true"></i></span></li>
